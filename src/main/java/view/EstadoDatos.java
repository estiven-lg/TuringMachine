...
public class EstadoDatos extends javax.swing.JFrame {
    ...
    public void actualizarEstadoActualCinta(List<Character> tape, int headPosition) {
        ...
        estadoActual.append(String.valueOf(TuringMachine.blankSymbol).repeat(5));
...
//        Boolean machingReady = true; // turingMachine.canProceed();
        ...
        btnSiguienteEstado.setEnabled(turingMachine.canProceed());
        actualizarEstadoActualCinta(turingMachine.getTape(), turingMachine.getHeadPosition());
        if (turingMachine.canProceed()) {
            ...
            if (turingMachine.isValidInput()) {
                labelResultado.setText("cadena valida :D ");
                labelResultado.setForeground(Color.GREEN);
            } else {
                labelResultado.setText("cadena no valida D: ");
    ...
    private void initComponents() {
        ...
        pnlCintaPosicionLayout.setHorizontalGroup(
            ...
            .addGroup(pnlCintaPosicionLayout.createSequentialGroup()
                .addGroup(pnlCintaPosicionLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(pnlCintaPosicionLayout.createSequentialGroup()
                        .addGap(37, 37, 37)
                        .addGroup(pnlCintaPosicionLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(lblPosicionActual1, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(lblCintaPosicion, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(pnlCintaPosicionLayout.createSequentialGroup()
                        .addGap(15, 15, 15)
                        .addComponent(lblCinta, javax.swing.GroupLayout.PREFERRED_SIZE, 311, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        pnlEstadoCadenaLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnlEstadoCadenaLayout.createSequentialGroup()
                ...
                .addGroup(pnlEstadoCadenaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
